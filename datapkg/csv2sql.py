...
def configure_csv2sql_parser(parser):
    """Populate `parser` with required arguments.

    Used by `__main__.py` as a CLI entry point.
    """
...
def parse_args():
    ...
    configure_csv2sql_parser(parser)
